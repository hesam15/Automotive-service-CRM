    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        @foreach ($serviceCenters as $serviceCenter)
            <div class="bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300">
                <div class="relative">
                    <img src="{{ $serviceCenter->thumbnail_path ? asset('storage/' . $serviceCenter->thumbnail_path) : 'https://via.placeholder.com/600x300' }}" 
                        alt="تصویر مجموعه" 
                        class="w-full h-48 object-cover rounded-t-xl">
                    <div class="absolute top-4 left-4">
                        <span class="bg-green-500 text-white px-3 py-1 rounded-full text-sm">
                            {{ $serviceCenter->is_open ? 'باز است' : 'بسته است' }}
                        </span>
                    </div>
                </div>
                ...
                <div class="p-6">
                    <div class="flex justify-between items-start mb-4">
                        <div>
                            <h3 class="text-xl font-bold text-gray-800">{{ $serviceCenter->name }}</h3>
                            <div class="flex items-center mt-1">
                                <div class="flex items-center text-yellow-400">
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                                    </svg>
                                    <span class="mr-1 text-gray-600">4.8</span> <!-- امتیاز را می‌توانید از مدل یا رابطه دیگری بگیرید -->
                                </div>
                                <span class="mx-2 text-gray-400">|</span>
                                <span class="text-gray-600">142 نظر</span> <!-- تعداد نظرات را می‌توانید از مدل یا رابطه دیگری بگیرید -->
                            </div>
                        </div>
                    ...
                    <div class="space-y-3 text-gray-600 mb-6">
                        <div class="flex items-center">
                            ...
                            <span class="mr-2">{{ $serviceCenter->address }}</span>
                        </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <span class="mr-2">{{ $serviceCenter->working_hours }}{{ $serviceCenter->fridays_off ? ' (جمعه‌ها تعطیل)' : '' }}</span>
                        </div>

                        <div class="flex flex-wrap gap-2">
                            <!-- برچسب‌ها را می‌توانید از رابطه یا فیلد دیگری بگیرید -->
                    ...
                    <div class="flex items-center justify-between">
                        <a href={{ route('show.serviceCenter', $serviceCenter->id) }} class="flex-1 bg-blue-600 text-white py-3 rounded-lg hover:bg-blue-700 transition duration-150 text-center">
                            مشاهده و رزرو
                        </a>
