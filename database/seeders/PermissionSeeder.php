...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        Permission::insert([
            ...
            ['name' => 'view_cars'], ['name' => 'create_cars'], ['name' => 'edit_cars'], ['name' => 'delete_cars'],
            ['name' => 'view_options'] ,['name' => 'create_options'], ['name' => 'edit_options'], ['name' => 'delete_options'],
            ['name' => 'view_reports'] ,['name' => 'create_reports'], ['name' => 'edit_reports'], ['name' => 'delete_reports'],
